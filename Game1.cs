...
namespace DonkeyKong
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //GameManager.AddGameObject(new EnemyController(ResourceManager.GetTexture("enemy_spritesheet-1"), new Vector2(120, 414), 10, new Point(0, 0), new Point(50, 26), new Point(3, 1), Color.White, 0f, 1, 0f, Vector2.Zero, 100));
            //GameManager.AddGameObject(new EnemyController(ResourceManager.GetTexture("enemy_spritesheet-1"), new Vector2(120, 494), 10, new Point(0, 0), new Point(50, 26), new Point(3, 1), Color.White, 0f, 1, 0f, Vector2.Zero, 100));
